...
outEDMFileName = 'l1tCalo_2016_EDM.root'
outHistoFileName = 'l1tCalo_2016_histos.root'
if options.outFileSuffix:
    outEDMFileName = 'l1tCalo_2016_EDM_' + options.outFileSuffix + ".root"
    outHistoFileName = 'l1tCalo_2016_histos_' + options.outFileSuffix + ".root"
