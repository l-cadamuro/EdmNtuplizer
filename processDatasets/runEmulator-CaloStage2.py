...
options.register('outFilePath',
                 None,
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 'name of output file')
options.register('outFileSuffix',
                 None,
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 'suffix for utput file name')
...
outEDMFileName = 'l1tCalo_2016_simEDM.root'
outHistoFileName = 'l1tCalo_2016_simHistos.root'
if options.outFileSuffix:
    outEDMFileName = 'l1tCalo_2016_simEDM_' + options.outFileSuffix + ".root"
    outHistoFileName = 'l1tCalo_2016_simHistos_' + options.outFileSuffix + ".root"
if options.outFilePath:
    outEDMFileName = options.outFilePath + "/" + outEDMFileName
    outHistoFileName = options.outFilePath + "/" + outHistoFileName

# Output definition
process.output = cms.OutputModule(
    "PoolOutputModule",
    outputCommands = cms.untracked.vstring("keep *"),
    fileName = cms.untracked.string(outEDMFileName)
)

# Additional output definition
# TTree output file
process.load("CommonTools.UtilAlgos.TFileService_cfi")
process.TFileService.fileName = cms.string(outHistoFileName)
